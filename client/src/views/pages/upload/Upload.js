            ...
            <div className="row g-3">
              ...
              <div className="col-6 ">
                ...
                <div className="mt-10 img-note">
                  Check the sample file before upload <a href="http://qa-dev.conceptbiu.com/unifiedapi/unifiedapi/qualitative/sample_template1666253552888.xlsx" target="_blank">Sample file</a>
                </div>
              </div>
            </div>
